...
void hashfast_init_cfgdata(struct hashfast_chip_state * const chipstate)
{
	...
	const uint16_t status_ms = 0/*FIXME*/;
	const bool send_status_on_core_idle = false/*FIXME*/;
	const bool send_status_on_pending_empty = false/*FIXME*/;
	const bool pwm_active_level = false;
	const uint8_t status_batching_delay_ms = 0/*FIXME*/;
	const uint8_t watchdog_sec = 0/*FIXME*/;
	...
	// FIXME: Make sure one_usec is the same as clock
	pk_u16le(cfgdata, 8,
	         (chipstate->clock & 0xfff) |
